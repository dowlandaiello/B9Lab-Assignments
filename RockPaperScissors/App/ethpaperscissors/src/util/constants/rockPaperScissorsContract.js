const address = '0x5ef51758449f9151b1bd06d4EAbBBA3dD0F7dEd9';
...
const ABI = [{
  ...
  constant: false, inputs: [{ name: '_inviteCode', type: 'bytes32' }, { name: '_move', type: 'uint256' }], name: 'revealMove', outputs: [], payable: false, stateMutability: 'nonpayable', type: 'function',
}, {
