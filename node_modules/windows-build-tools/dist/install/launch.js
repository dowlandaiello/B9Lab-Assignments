...
function launchInstaller() {
    return new Promise((resolve, reject) => {
        const vccParam = `-VisualStudioVersion '${constants_1.buildTools.version.toString()}'`;
        const pathParam = `-BuildToolsInstallerPath '${vccInstaller.directory}'`;
        const buildToolsParam = constants_1.isBuildToolsInstalled
            ? ``
            : `-InstallBuildTools -ExtraBuildToolsParameters '${get_build_tools_parameters_1.getBuildToolsExtraParameters()}'`;
        const pythonParam = constants_1.isPythonInstalled
            ? ``
        ...
        try {
            ...
            logging_1.log('(Hint: Is "%SystemRoot%\\system32\\WindowsPowerShell\\v1.0" in your system path?)');
            return reject(error);
        }
