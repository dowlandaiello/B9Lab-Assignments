...
function download(cb) {
    const downloads = [downloadTools(get_build_tools_installer_path_1.getBuildToolsInstallerPath())];
    if (!constants_1.isPythonInstalled) {
        downloads.push(downloadTools(get_python_installer_path_1.getPythonInstallerPath()));
    }
    Promise.all(downloads)
        .then(() => cb())
        .catch((error) => logging_1.log(error));
}
